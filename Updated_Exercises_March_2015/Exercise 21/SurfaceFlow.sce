...
// and tracer distributions in the surface layer.

clf; scf(0); a=gcf(); a.figure_size= [1000,450];a.color_map = hsvcolormap(64);

// read input data
tin=read("t1.dat",-1,101); h0=read("h0.dat",-1,101); 
u1=read("u1.dat",-1,101); v1=read("v1.dat",-1,101);
e1=read("eta1.dat",-1,101);
